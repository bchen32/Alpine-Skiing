...
func _physics_process(delta: float) -> void:
	...
	velocity = velocity.rotated(
		Globals.normal, -inv_angle_diff * turn_angle_coeff * angle_diff * rtc_angle_coeff * delta
	)
	...
	# Only move player along lateral velocity
	# Downhill velocity will be simulated by moving obstacles uphill
